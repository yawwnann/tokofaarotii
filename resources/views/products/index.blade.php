...
<style>
    ...
    /* ─ Primary Button ─ */
    .btn-primary { display:inline-flex; align-items:center; gap:.4rem; padding:.5rem 1rem; background:var(--color-primary,#ea580c); color:#fff; border:none; border-radius:.5rem; font-size:.825rem; font-weight:600; cursor:pointer; text-decoration:none; box-shadow:0 3px 10px rgba(249,115,22,.35); transition:box-shadow .2s,transform .15s; white-space:nowrap; }
    ...
    .btn-submit.update-mode { display:inline-flex; align-items:center; gap:.375rem; padding:.5rem 1.375rem; background:var(--color-primary,#ea580c); color:#fff; border:none; border-radius:.5rem; font-size:.825rem; font-weight:600; cursor:pointer; box-shadow:0 3px 10px rgba(249,115,22,#f97316); transition:box-shadow .2s,transform .15s; }
